...
const EMPTY_FORM = {nombre:'',edad:'',talla:'',peso:'',posicion:'',equipoId:'', foto:'', goles: 0, amarillas: 0, rojas: 0, lesionado: false, suspendido: false}
      ...
      {(() => {
        ...
        >
          ...
          <div className="flex items-center gap-4 text-sm">
            <span>⚽ {p.goles}</span>
            <span className="text-yellow-400">🟨 {p.amarillas}</span>
            <span className="text-red-400">🟥 {p.rojas}</span>
            {p.lesionado && (
